/**
 * rede-de-confianca/page.tsx
 * Placeholder da rede de confiança — RSC protegido.
 *
 * Conecta: (app)/layout | AppShell via layout
 * Camada: server (RSC)
 */
...
export default function RedeDeConfiancaPage() {
  return (
