...
export function ArticlePageFrame({
  ...
  return (
    <main className="min-h-screen bg-[#c8d2b7] text-[var(--color-ink)]">
      ...
      <div className="mx-auto w-full max-w-[780px] px-5 py-10 sm:px-8 sm:py-14">
        <section className="overflow-hidden rounded-[30px] border border-[rgba(42,37,32,0.08)] bg-[var(--color-cream)] shadow-[0_28px_70px_rgba(42,37,32,0.12)]">
          <div className="bg-[var(--color-green-dark)] px-6 py-9 text-[var(--color-cream)] sm:px-10 sm:py-12">
            {eyebrow && (
              <p className="mb-4 font-sans text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--color-cream-70)]">
                {eyebrow}
              </p>
            )}
            <h1 className="font-serif text-[clamp(26px,4.5vw,42px)] font-semibold leading-[1.1] tracking-[-0.02em]">
              {title}
            </h1>
